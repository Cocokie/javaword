...
public class ClientLx {
    ...
    private static void send2(OutputStream outputStream,String data) throws IOException {
        BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(outputStream);
        bufferedOutputStream.write(data.getBytes());
        bufferedOutputStream.flush();
    }

    private static String receive2(InputStream inputStream) throws IOException {
        String line = null;
