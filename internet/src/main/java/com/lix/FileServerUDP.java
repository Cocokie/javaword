...
public class FileServerUDP {
    public static void main(String[] args) {
        ...
        try {
            ...
            DatagramPacket datagramPacket = new DatagramPacket(new byte[1024 * 1024 * 5], 5 * 1024 * 1024);
            ...
            while (true) {
                ...
                bufferedOutputStream = new BufferedOutputStream(new FileOutputStream(s + new Date()));
